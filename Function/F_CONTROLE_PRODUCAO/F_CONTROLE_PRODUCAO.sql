...
BEGIN
  ...
  THEN
    ...
    FOR DADOS IN (SELECT MOV.TIPO,MOV.SEQMOV,MOV.NUMTRANSENT,MOV.NUMTRANSVENDA,MOV.ESPECIE,MOV.SERIE,MOV.CODCONT,MOV.OBSERVACAO,
                         ...
                         MOV.CUSTOULTENTFINSEMST,MOV.CUSTOULTENTLIQ,MOV.STATUS, MOV.CUSTOREALLIQ, MOV.ID_PCMOV, MOV.ID_PCMOVCOMPLE
                   FROM (SELECT TIPO,SEQMOV,BASECUSTOCONT,CUSTOCONT,CUSTOFIN,CUSTOREAL,CUSTOREP,CUSTOULTENT
                               ...
                               ,CUSTOFINSEMST,CUSTOULTENTFIN,CUSTOULTENTSEMST,CUSTOULTENTFINSEMST,CUSTOULTENTLIQ,STATUS,CUSTOREALLIQ,ID_PCMOV,ID_PCMOVCOMPLE
