    ...
    IF (VS_DIABLOQUEADO = 'N') AND (VS_MESABERTO = 'S') AND (VS_PERIODOABERTO = 'S') AND
      ...
      IF LANCINTERMEDIARIA.AGRUPAMENTOREGRA = 'I' THEN
        ...
        IF (LANCINTERMEDIARIA.NUMTRANSCENTROCUSTO IS NOT NULL) AND (VS_USACENTROCUSTO = 'S') THEN
           P_GRAVA_DADOS_CENTROCUSTO(LANCINTERMEDIARIA.NUMTRANSCENTROCUSTO, VN_NUMTRANSLANCTO, LANCINTERMEDIARIA.NATUREZA, LANCINTERMEDIARIA.HISTORICO_COMPL || LANCINTERMEDIARIA.CODREDUZIDO_PC || LANCINTERMEDIARIA.CODFILIAL || LANCINTERMEDIARIA.OPERACAO);
        END IF;
