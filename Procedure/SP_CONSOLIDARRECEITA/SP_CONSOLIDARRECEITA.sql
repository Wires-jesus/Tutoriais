...
--                       , SUM(DECODE(NVL(PCMOV.PUNITCONT,0), 0, NVL(PCMOV.PUNIT,0), PCMOV.PUNITCONT) * DECODE(NVL(PCMOV.QTCONT,0),0, NVL(PCMOV.QT,0), PCMOV.QTCONT)) VLTOTALNOTA
         ...
         END), 'S', NVL(PCMOV.VLDESCRODAPE, 0), 0) +
                       ...
                       , SUM(NVL(PCMOVCOMPLE.VLACRESCIMOFUNCEP,0) * DECODE(NVL(PCMOV.QTCONT,0),0, NVL(PCMOV.QT,0), PCMOV.QTCONT)) VLFUNCEP
                       , SUM(NVL(PCMOVCOMPLE.VLICMSDIFALIQPART,0) * DECODE(NVL(PCMOV.QTCONT,0),0, NVL(PCMOV.QT,0), PCMOV.QTCONT)) VLICMSDIFERENCIALALIQ
                       , SUM(NVL(PCMOVCOMPLE.VLICMSPARTDEST,0) * DECODE(NVL(PCMOV.QTCONT,0),0, NVL(PCMOV.QT,0), PCMOV.QTCONT)) VLICMSUFDESTINO
                       , SUM(NVL(PCMOVCOMPLE.VLICMSPARTREM,0) * DECODE(NVL(PCMOV.QTCONT,0),0, NVL(PCMOV.QT,0), PCMOV.QTCONT)) VLICMSUFREMETENTE
