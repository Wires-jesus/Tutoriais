CREATE OR REPLACE PACKAGE FISCAL IS
  ...
  TYPE TIPO_PCCSTTRIBUTACAOIBSCBS IS RECORD (
     GERA_GRUPO_IBS_CBS        VARCHAR2(3));   

  TYPE TIPO_GRUPO_DIFERIMENTO IS RECORD (
     PERC_DIFERIMENTO       NUMBER(7,4),
     VALOR_DIFERIMENTO      NUMBER(7,4));

  TYPE TIPO_GRUPO_COMPRA_GOV IS RECORD (
     TIPO_OPERACAO_GOV        VARCHAR2(1),
  ...
  TYPE TIPO_GRUPO_TRIBUTACAO_REGULAR IS RECORD (
     COD_TRIB_REGULAR       NUMBER(10),
     CST_TRIB_REG           VARCHAR2(3),
     CCLASSTRIB_REG         VARCHAR2(6),
     ALIQ_EFET_REG_IBS_UF   NUMBER(7,4), 
     ALIQ_EFET_REG_IBS_MUN  NUMBER(7,4),
     ALIQ_EFET_REG_CBS      NUMBER(7,4),
     VTRIB_REG_CBS          NUMBER(23,10),
     VTRIB_REG_IBS_UF       NUMBER(23,10),
     VTRIB_REG_IBS_MUN      NUMBER(23,10),
     -- Auxiliares
     COD_FORMULA_BASE_TRIB_REG      VARCHAR2(200), 
     FORMULA_BASE_CALCULO_TRIB_REG  VARCHAR2(4000), 
     VALOR_BASE_TRIB_REG            NUMBER(23,10), 
     VLTOTAL_TRIB_REGULAR           NUMBER(23,10)     
     );      
  ...
  TYPE TIPO_TRIBUT_REFORMA IS RECORD (
      ...
      DADOS_DIFERIMENTO_CBS TIPO_GRUPO_DIFERIMENTO,      
      ...
      DADOS_DIFERIMENTO_IBS_UF TIPO_GRUPO_DIFERIMENTO,      
      --Retorno valores IBS
      ...
      DADOS_DIFERIMENTO_IBS_MUN TIPO_GRUPO_DIFERIMENTO,
      --Retornos valores IS
  ...
  TYPE TIPO_CODIGO_BENEFICIO_FISCAL IS RECORD (
       NATUREZAVINCULO   VARCHAR2(1),
       TIPOCLIENTEFORNEC VARCHAR2(15),
       CODFILIAL         VARCHAR2(2),
       CODPROD           NUMBER(6),
       UFORIGEM          VARCHAR2(2),
       ...
       CODBENEFICIOFISCALRBC          VARCHAR2(10), 
       CODBENEFICIOFISCALEXCECAO      VARCHAR2(10),
   ...
   FUNCTION FIL_OPTANTESIMPLESNACIONAL(P_CODFILIAL VARCHAR2) RETURN BOOLEAN;      
  ...
  RETURN TIPO_CODIGO_BENEFICIO_FISCAL;
