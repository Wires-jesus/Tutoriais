CREATE OR REPLACE PACKAGE FISCAL IS
  ...
  TYPE TIPO_TRIBUT_REFORMA IS RECORD (
      ...
      VALOR_BASE_CBSIBS               NUMBER(22,10),
      --Retorno valores CBS
      PERC_CBS                NUMBER(7,4),
      PERC_RED_CBS            NUMBER(7,4),
      ALIQ_EFETIVA_CBS        NUMBER(7,4),
      VALOR_CBS               NUMBER(22,10),
      ...
      VALOR_BASE_IS               NUMBER(22,10),
      PERC_IS                     NUMBER(7,4),
      VALOR_IS                    NUMBER(22,10),
      VLTOTALIBS                  NUMBER(22,10),
