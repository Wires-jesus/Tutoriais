 CREATE OR REPLACE PACKAGE FISCAL IS
  ...
  TYPE TIPO_GRUPO_TRIBUTACAO_REGULAR IS RECORD (
     ...
     TRIB_REG_IBS_UF        NUMBER(23,10),
     ALIQ_EFET_REG_IBS_MUN  NUMBER(7,4),
     TRIB_REG_IBS_MUN       NUMBER(23,10),
     ALIQ_EFET_REG_CBS      NUMBER(7,4),
     TRIB_REG_CBS           NUMBER(23,10),
     COD_FORMULA_BASE_TRIB_REG      VARCHAR2(200), 
     FORMULA_BASE_CALCULO_TRIB_REG  VARCHAR2(4000), 
     VALOR_BASE_TRIB_REG            NUMBER(23,10), 
     FORMULA_VALOR_TRIB_REGULAR     VARCHAR2(4000),
     FORMULA_VALOR_TRIB_REGULAR_UF  VARCHAR2(4000),
     FORMULA_VALOR_TRIB_REGULAR_MUN VARCHAR2(4000),
     VALOR_TRIB_REGULAR             NUMBER(23,10),
     VALOR_TRIB_REGULAR_UF          NUMBER(23,10),
     VALOR_TRIB_REGULAR_MUN         NUMBER(23,10),
