 ...
 -- 
    ...
    BEGIN
      ...
      END IF;
       ...
       V_PARAMETROS.TRIBUTACAO_REGULAR.VLTOTAL_TRIB_REGULAR := ROUND(V_PARAMETROS.TRIBUTACAO_REGULAR.VTRIB_REG_IBS_UF,2) + ROUND(V_PARAMETROS.TRIBUTACAO_REGULAR.VTRIB_REG_IBS_MUN,2);
