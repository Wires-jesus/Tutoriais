    ...
    BEGIN
      SELECT PCTRIBUTACAO.CODIGO_TRIBUTACAO,
        ...
        INTO V_CODIGO_TRIBUTACAO_CBSIBS,
             ...
             V_PERC_IS
        FROM PCTRIBUTACAO 
            ,(SELECT * FROM PCTRIBUTACAO_FILTRO_PRODUTO WHERE PCTRIBUTACAO_FILTRO_PRODUTO.DTEXCLUSAO IS NULL) PCTRIBUTACAO_FILTRO_PRODUTO
            ,(SELECT * FROM PCTRIBUTACAO_FILTRO_NCM     WHERE PCTRIBUTACAO_FILTRO_NCM.DTEXCLUSAO IS NULL)     PCTRIBUTACAO_FILTRO_NCM
       WHERE TIPO_IMPOSTO = P_PARAMETROS.TIPO_IMPOSTO
         ...
         AND ((P_TIPO_LOCAL_CONSUMO = 'M' AND LOCAL_CONSUMO_MUNICIPIO = P_LOCAL_CONSUMO) OR
              (P_TIPO_LOCAL_CONSUMO = 'G' AND LOCAL_CONSUMO_GERAL = P_LOCAL_CONSUMO))
         AND ((P_PARAMETROS.DATA BETWEEN PCTRIBUTACAO.DTINICIO_VIGENCIA AND PCTRIBUTACAO.DTFIM_VIGENCIA) OR 
