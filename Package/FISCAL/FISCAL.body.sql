...
--RATEIO OUTRAS DESPESAS E FRETE (ILQUIAS 20/07/2011)
 ...
 FUNCTION GET_DESCRICAO_NATUREZA_OP(
  ...
  FUNCTION REDUCAO_CONFORME_PCCSTTRIB(P_PARAMETROS IN TIPO_TRIBUT_REFORMA)-- REDUCAO_CONFORME_PCCSTTRIBUTACAOCBSIBS
  ...
  END REDUCAO_CONFORME_PCCSTTRIB;      
  ...
  RETURN TIPO_TRIBUT_REFORMA IS
    ...
    PKG_DEBUGGING_FWPC.LOG('Iniciando consulta na PCTRIBUTACAO com os seguintes parâmetros:'
      ...
      V_PARAMETROS := REDUCAO_CONFORME_PCCSTTRIB(V_PARAMETROS);
