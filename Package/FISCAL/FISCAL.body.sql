    ...
    BEGIN    
      ...
      SELECT PCTRIBUTACAO.CODIGO_TRIBUTACAO,             
       ...
       WHERE PCTRIBUTACAO.CODIGO_TRIBUTACAO = PCTRIBUTACAO_EXCECAO.CODIGO_TRIBUTACAO(+)       
         ...
         AND STATUS = 'A'         
         AND (PCTRIBUTACAO_FILTRO_PRODUTO.CODPROD IN (P_PARAMETROS.CODPROD) OR P_PARAMETROS.CODPROD IS NULL)
         AND (PCTRIBUTACAO_FILTRO_NCM.NCM IN (P_PARAMETROS.NCM) OR P_PARAMETROS.NCM IS NULL)         
         ...
         AND (P_PARAMETROS.TIPO_PESSOA IS NULL OR NVL(PCTRIBUTACAO_EXCECAO.TIPO_PESSOA, NVL(PCTRIBUTACAO.TIPO_PESSOA,'N')) = P_PARAMETROS.TIPO_PESSOA)
         AND (P_PARAMETROS.ORGAO_PUBLICO IS NULL OR NVL(PCTRIBUTACAO_EXCECAO.ORGAO_PUBLICO, NVL(PCTRIBUTACAO.ORGAO_PUBLICO,'N')) = P_PARAMETROS.ORGAO_PUBLICO)
         AND (P_PARAMETROS.ORIGEM_MERCADORIA IS NULL OR NVL(PCTRIBUTACAO_EXCECAO.ORIGEM_MERCADORIA, NVL(PCTRIBUTACAO.ORIGEM_MERCADORIA,'N')) = P_PARAMETROS.ORIGEM_MERCADORIA)
