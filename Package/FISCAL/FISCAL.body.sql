...
--RATEIO OUTRAS DESPESAS E FRETE (ILQUIAS 20/07/2011)
 ...
 -- 
    ...
    BEGIN
      ...
      V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_BASE_CALCULO_TRIB_REG := VFORMULA_TRIBUTOS;

      VARIAVEL.NOME  := '&BASE_CALCULO_CBSIBS&';
      VARIAVEL.VALOR := V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_BASE_CALCULO_TRIB_REG;
      FORMULA.ATRIBUIVALOR(VARIAVEL, VTVARIAVEIS);

      V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_BASE_TRIB_REG := FORMULA.CALCULARSUBFORMULA(VFORMULA_TRIBUTOS, VTVARIAVEIS);
      ...
      -- Cálculo para Orgão Publico --
      IF V_PARAMETROS.COMPRA_GOVERNAMENTAL.TIPO_ORGAOPUBLICO IS NOT NULL AND 
      ...
      END IF;
       ...
       V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR     := 
         FORMULA.SubstituiVariaveisF(V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR,VTVARIAVEIS);
         
       V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR_UF  := 
         FORMULA.SubstituiVariaveisF(V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR_UF,VTVARIAVEIS);

       V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR_MUN := 
         FORMULA.SubstituiVariaveisF(V_PARAMETROS.TRIBUTACAO_REGULAR.FORMULA_VALOR_TRIB_REGULAR_MUN,VTVARIAVEIS);

       V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_TRIB_REGULAR     := ROUND(((V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_BASE_TRIB_REG * V_ALIQ_EFET_REG_CBS)/100),10);
       V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_TRIB_REGULAR_UF  := ROUND(((V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_BASE_TRIB_REG * V_ALIQ_EFET_REG_IBS_UF)/100),10);
       V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_TRIB_REGULAR_MUN := ROUND(((V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_BASE_TRIB_REG * V_ALIQ_EFET_REG_IBS_MUN)/100),10);
       V_PARAMETROS.TRIBUTACAO_REGULAR.VLTOTAL_TRIB_REGULAR   := ROUND(V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_TRIB_REGULAR_UF,2) + 
                                                                 ROUND(V_PARAMETROS.TRIBUTACAO_REGULAR.VALOR_TRIB_REGULAR_MUN,2);
      ...
      IF ((P_PARAMETROS.COD_FORMULA_BASE_CBSIBS IS NOT NULL) AND
         ...
         IF (P_PARAMETROS.TIPO_IMPOSTO = 'CBSIBS') THEN
           ...
           IF ((P_PARAMETROS.TRIBUTACAO_REGULAR.COD_TRIB_REGULAR > 0) AND 
             ((NVL(P_PARAMETROS.PERC_RED_CBS,0) + 
               NVL(P_PARAMETROS.PERC_RED_ALIQ_IBS_MUN,0) +
               NVL(P_PARAMETROS.PERC_RED_ALIQ_IBS_UF,0)) > 0))  THEN 
    ...
    IF V_PARAMETROS.CODCLI > 0 THEN
      BEGIN
        ...
        SELECT PCCIDADE.CODIBGE,
               ...
               PCCLIENT.TIPOORGAOPUB,
               PCCLIENT.PERCREDORGAOPUB
      ...
      BEGIN
        ...
        SELECT PCCIDADE.CODIBGE,
               ...
               CASE
                  ...
                  ELSE 'N'
               END AS ORGAO_PUBLICO,
               NVL(PCFORNEC.TIPOORGAOPUB, PCCLIENT.TIPOORGAOPUB) TIPOORGAOPUB,
  ...
  BEGIN
    BEGIN
      ...
      IF ((V_DADOS_TRIBUTACAO.TRIBUTACAO_REGULAR.COD_TRIB_REGULAR > 0) AND 
          ((NVL(V_DADOS_TRIBUTACAO.PERC_RED_CBS,0) + 
            NVL(V_DADOS_TRIBUTACAO.PERC_RED_ALIQ_IBS_MUN,0) +
            NVL(V_DADOS_TRIBUTACAO.PERC_RED_ALIQ_IBS_UF,0)) > 0))  THEN 
