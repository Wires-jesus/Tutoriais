    ...
    BEGIN
      SELECT PCTRIBUTACAO.CODIGO_TRIBUTACAO,
       ...
       WHERE TIPO_IMPOSTO = P_PARAMETROS.TIPO_IMPOSTO
         ...
         AND NVL(PCTRIBUTACAO.CONSUMIDOR_FINAL, 'N') IN (NVL(P_PARAMETROS.CONSUMIDOR_FINAL,'N'), 'N')
         AND NVL(PCTRIBUTACAO.TIPO_EMPRESA, 'N') IN (NVL(P_PARAMETROS.TIPO_EMPRESA,'N'), 'N')
         AND NVL(PCTRIBUTACAO.TIPO_PESSOA, 'N') IN (NVL(P_PARAMETROS.TIPO_PESSOA,'N'), 'N')
         AND NVL(PCTRIBUTACAO.ORGAO_PUBLICO, 'N') IN (NVL(P_PARAMETROS.ORGAO_PUBLICO,'N'), 'N')
         AND NVL(PCTRIBUTACAO.ORIGEM_MERCADORIA,'N') IN (NVL(P_PARAMETROS.ORIGEM_MERCADORIA,'N'), 'N')
         AND NVL(PCTRIBUTACAO.TIPO_MERC, 'N') IN (NVL(P_PARAMETROS.TIPO_MERC,'N'), 'N')
         AND (
