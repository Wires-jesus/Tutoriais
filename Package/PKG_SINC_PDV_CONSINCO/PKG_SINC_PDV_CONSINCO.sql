CREATE OR REPLACE PACKAGE PKG_SINC_PDV_CONSINCO IS
  ...
  procedure carrega_tb_precoapartirsegment(p_id in pccontroleconsinco.id%type);
  ...
  procedure carrega_tb_limitevendaperiodo(p_id in pccontroleconsinco.id%type);
  
  procedure carrega_tb_limitevendaempresa(p_id in pccontroleconsinco.id%type);
  ...
  PROCEDURE carrega_tb_convenioperiodo(p_id IN pccontroleconsinco.id%TYPE) ;
  ...
  PROCEDURE carrega_tb_cartaopresente(p_id IN pccontroleconsinco.id%TYPE);
  ...
  PROCEDURE carrega_tb_cctaliquota(p_id IN pccontroleconsinco.id%TYPE);
  
  PROCEDURE carrega_tb_cctcenarioitem(p_id IN pccontroleconsinco.id%TYPE);

  PROCEDURE carrega_tb_regiao(p_id IN pccontroleconsinco.id%TYPE);
