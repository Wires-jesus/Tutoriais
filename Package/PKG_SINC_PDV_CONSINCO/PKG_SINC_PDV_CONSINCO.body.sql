CREATE OR REPLACE PACKAGE BODY PKG_SINC_PDV_CONSINCO IS
  ...
  BEGIN 
    ...
    USING(SELECT * FROM VW_INT_C5_ENDERECO_ALTERNATIVO A WHERE A.CODFILIAL IN (SELECT CODFILIAL FROM VW_INT_C5_OBTER_FILIAIS_C5)) VW_INT_C5_ENDERECO_ALTERNATIVO
