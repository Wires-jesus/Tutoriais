...
BEGIN
  ...
  MERGE INTO MONITORPDVMIDDLE.TB_PRECOAPARTIRSEGMENTO TB_PRECOAPARTIRSEGMENTO
    USING (SELECT SEQPRECOAPARTIR, NROSEGMENTO, ATIVO FROM VW_INT_C5_PRECOAPARTIR) T
...
BEGIN
  ...
  MERGE INTO MONITORPDVMIDDLE.TB_PRECOAPARTIRPERIODO TB_PRECOAPARTIRPERIODO
    USING (SELECT SEQPRECOAPARTIR, DTAHORINICIO, DTAHORFIM, ATIVO FROM VW_INT_C5_PRECOAPARTIR) T
