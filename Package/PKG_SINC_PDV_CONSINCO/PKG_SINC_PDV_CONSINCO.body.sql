...
BEGIN
  ...
  MERGE INTO MONITORPDVMIDDLE.TB_PRECOAPARTIRPRODUTO TB_PRECOAPARTIRPRODUTO
    USING (SELECT SEQPRECOAPARTIR, SEQPRODUTO, PRECO, PERCDESCONTO, QTDE, ATIVO FROM VW_INT_C5_PRECOAPARTIRPERIODO) T
  ...
  WHEN MATCHED THEN
    UPDATE SET
      TB_PRECOAPARTIRPRODUTO.DTAHORINICIO = T.PRECO, 
      TB_PRECOAPARTIRPRODUTO.DTAHORFIM = T.PERCDESCONTO,
