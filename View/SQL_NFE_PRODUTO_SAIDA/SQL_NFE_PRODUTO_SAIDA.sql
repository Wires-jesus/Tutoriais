...
------------------------------------------------------------------------------------------------------------
          ...
          ,CASE WHEN (PCMOV.CODOPER ='SD' AND PARAMFILIAL.OBTERCOMOVARCHAR2('ENVIASIMPNACDEVFORNECNFE', PCFILIAL.CODIGO) = 'N') AND
           ...
           ,CASE  WHEN NVL(PCMOVCOMPLE.QTLITRAGEM, PCPRODUT.LITRAGEM) > 0
            ...
            ,PCMOV.CSTCBS
            ,PCMOV.CCLASSTRIBCBS
            ,ROUND(PCMOV.QTCONT * NVL(PCMOV.VLBASECBS, 0), 2) AS VLBASECBS
            ,NVL(PCMOV.ALIQCBS, 0) AS ALIQCBS
            ,NVL(PCMOV.PERCREDBASECBS, 0) AS PERCREDBASECBS
            ,ROUND(PCMOV.QTCONT * NVL(PCMOV.VLCBS, 0), 2) AS VLCBS
            ,NVL(PCMOV.ALIQESPECIFICACBS, 0) AS ALIQESPECIFICACBS
            ,PCMOV.CODIGOTRIBUTACAOIBS
            ,PCMOV.CSTIBS
            ,PCMOV.CCLASSTRIBIBS
            ,ROUND(PCMOV.QTCONT * NVL(PCMOV.VLBASEIBS, 0), 2) AS VLBASEIBS
            ,NVL(PCMOV.ALIQIBS, 0) AS ALIQIBS
            ,NVL(PCMOV.PERCREDBASEIBS, 0) AS PERCREDBASEIBS
            ,ROUND(PCMOV.QTCONT * NVL(PCMOV.VLIBS, 0), 2) AS VLIBS
            ,NVL(PCMOV.ALIQESPECIFICAIBS, 0) AS ALIQESPECIFICAIBS
...
------------------------------------------------------------------------------------------------------------
          ...
          ,CASE WHEN (PCMOVPREFAT.CODOPER ='SD' AND PARAMFILIAL.OBTERCOMOVARCHAR2('ENVIASIMPNACDEVFORNECNFE', PCFILIAL.CODIGO) = 'N') AND
           ...
           ,CASE  WHEN NVL(PCMOVCOMPLEPREFAT.QTLITRAGEM, PCPRODUT.LITRAGEM) > 0
            ...
            ,PCMOVPREFAT.CODIGOTRIBUTACAOCBS
            ,PCMOVPREFAT.CSTCBS
            ,PCMOVPREFAT.CCLASSTRIBCBS
            ,ROUND(PCMOVPREFAT.QTCONT * NVL(PCMOVPREFAT.VLBASECBS, 0), 2) AS VLBASECBS
            ,NVL(PCMOVPREFAT.ALIQCBS, 0) AS ALIQCBS
            ,NVL(PCMOVPREFAT.PERCREDBASECBS, 0) AS PERCREDBASECBS
            ,ROUND(PCMOVPREFAT.QTCONT * NVL(PCMOVPREFAT.VLCBS, 0), 2) AS VLCBS
            ,NVL(PCMOVPREFAT.ALIQESPECIFICACBS, 0) AS ALIQESPECIFICACBS
            ,PCMOVPREFAT.CODIGOTRIBUTACAOIBS
            ,PCMOVPREFAT.CSTIBS
            ,PCMOVPREFAT.CCLASSTRIBIBS
            ,ROUND(PCMOVPREFAT.QTCONT * NVL(PCMOVPREFAT.VLBASEIBS, 0), 2) AS VLBASEIBS
            ,NVL(PCMOVPREFAT.ALIQIBS, 0) AS ALIQIBS
            ,NVL(PCMOVPREFAT.PERCREDBASEIBS, 0) AS PERCREDBASEIBS
            ,ROUND(PCMOVPREFAT.QTCONT * NVL(PCMOVPREFAT.VLIBS, 0), 2) AS VLIBS
            ,NVL(PCMOVPREFAT.ALIQESPECIFICAIBS, 0) AS ALIQESPECIFICAIBS
