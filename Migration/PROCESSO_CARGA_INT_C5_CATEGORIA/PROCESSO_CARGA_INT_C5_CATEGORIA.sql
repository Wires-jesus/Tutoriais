...
SELECT
 ...
 FROM VW_INT_C5_CATEGORIA,
      ...
      PCDEPARACATEGORIAC5 C
 WHERE PRODCATEGORIA.NUMREGIAO||PRODCATEGORIA.SEQCATEGORIA = C.SEQCATEGORIAWINTHOR
 AND   PRODCATEGORIA.NUMREGIAO||PRODCATEGORIA.SEQCATEGORIA = VW_INT_C5_CATEGORIA.SEQCATEGORIAWINTHOR
