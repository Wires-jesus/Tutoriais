...
------------------
UNION ALL
  SELECT A.CODEPTO||B.CODSEC||2 SEQCATEGORIA,
...
------------------
UNION ALL
  SELECT A.CODEPTO||B.CODSEC||C.CODCATEGORIA||3 SEQCATEGORIA,
...
-----------------------
UNION ALL
  SELECT A.CODEPTO||B.CODSEC||C.CODCATEGORIA||D.CODSUBCATEGORIA||4 SEQCATEGORIA,
      ...
      (SELECT
         ...
         (CASE
            WHEN CODSUBCATEGORIA IS NOT NULL THEN
                 CODEPTO||CODSEC||CODCATEGORIA||CODSUBCATEGORIA||4
            WHEN CODCATEGORIA IS NOT NULL THEN
                 CODEPTO||CODSEC||CODCATEGORIA||3
