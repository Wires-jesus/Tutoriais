...
------------------
UNION ALL
  SELECT A.CODEPTO||1||B.CODSEC||2 SEQCATEGORIA,
...
------------------
UNION ALL
  SELECT A.CODEPTO||1||B.CODSEC||2||C.CODCATEGORIA||3 SEQCATEGORIA,
...
-----------------------
UNION ALL
  SELECT A.CODEPTO||1||B.CODSEC||2||C.CODCATEGORIA||3||D.CODSUBCATEGORIA||4 SEQCATEGORIA,
      ...
      (SELECT
         ...
         (CASE
            WHEN CODSUBCATEGORIA IS NOT NULL THEN
                 CODEPTO||1||CODSEC||2||CODCATEGORIA||3||CODSUBCATEGORIA||4
            WHEN CODCATEGORIA IS NOT NULL THEN
                 CODEPTO||1||CODSEC||2||CODCATEGORIA||3
