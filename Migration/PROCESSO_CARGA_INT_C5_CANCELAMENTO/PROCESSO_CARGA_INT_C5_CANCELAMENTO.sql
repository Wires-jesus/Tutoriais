...
SELECT  A.ROWID ROWID_TB_DOCTO,
        ...
        (CASE WHEN NF.DOCEMISSAO = 'SF' THEN NF.NUMCUPOMSAT ELSE (CASE
...
WHERE   A.SEQDOCTO = C.SEQDOCTO
  ...
  AND   A.REPLICACAO = 'P'
  AND   ((NF.PROTOCOLOENVIO IS NOT NULL  AND   NF.PROTOCOLOCANCNF IS NOT NULL AND NF.DOCEMISSAO = 'CE' ) OR (NF.DOCEMISSAO = 'SF' AND NF.NUMCUPOMSAT IS NOT NULL)) 
  AND   C.STATUS = 'C'
