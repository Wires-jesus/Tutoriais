...
SELECT
    ...
    NVL((CASE
         ...
         WHEN /*TRIBUTACAO PRODUTO FILHO É DIFERENTE DA TRIBUTACAO DO PRODUTO PAI*/
              ...
              DEPARA.SEQFAMILIA
         ELSE /*TRIBUTACAO PRODUTO FILHO É IGUAL A TRIBUTACAO DO PRODUTO PAI*/ 
...
(
  --OFERTA 2011 VAREJO
   SELECT
    ...
    TO_NUMBER(PCOFERTAPROGRAMADAC.CODFILIAL) NROEMPRESA,
...
--OFERTA 2011 ATACADO
 SELECT
  ...
  SELECT
    ...
    PCDEPARAPRODC5.SEQPRODUTO,
    TO_NUMBER(PCEMBALAGEM.CODFILIAL) NROEMPRESA,
    PCEMBALAGEM.QTUNIT QTDEMBALAGEM,  
    1 NROSEGMENTO,  
...
SELECT
  (SELECT X.SEQPRODUTO FROM PCDEPARAPRODC5 X WHERE X.CODPROD = CESTA.CODPRODACAB)SEQPRODCOMPOSTO,
  CESTA.SEQPRODUTO,
  CESTA.QTDEMBALAGEM,
  CESTA.QUANTIDADE,
...
WHERE C.CODPRECOCESTA = I.CODPRECOCESTA
AND   CESTA.CODPRODACAB = NVL(I.CODPRODACAB, CESTA.CODPRODACAB)
