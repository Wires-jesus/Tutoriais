...
(
  ...
  WHERE 
    ...
    AND SYSDATE BETWEEN NVL(PCOFERTAPROGRAMADAC.HORAINICIAL, PCOFERTAPROGRAMADAC.DTINICIAL)
                AND     NVL(PCOFERTAPROGRAMADAC.HORAFINAL  , PCOFERTAPROGRAMADAC.DTFINAL)
    ...
    AND PCOFERTAPROGRAMADAC.PRIORIDADEOFERTA = (
      ...
      WHERE 
        ...
        AND SYSDATE BETWEEN NVL(P.HORAINICIAL, P.DTINICIAL)
                    AND     NVL(P.HORAFINAL  , P.DTFINAL)
        AND I.VLOFERTA > 0
    )
