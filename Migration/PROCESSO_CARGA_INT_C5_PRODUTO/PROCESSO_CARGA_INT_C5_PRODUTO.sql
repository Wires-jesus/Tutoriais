...
--OFERTA 2011 ATACADO
 SELECT
  ...
  WHERE  
    ...
    AND SYSDATE BETWEEN TO_DATE(TO_CHAR(PCEMBALAGEM.DTOFERTAINI, 'DD-MM-YY') || ' 00:00:01','DD-MM-YY HH24:MI:SS','NLS_DATE_LANGUAGE = AMERICAN') 
  ...
  WHERE
    ...
    AND SYSDATE BETWEEN TO_DATE(TO_CHAR(PCEMBALAGEM.DTOFERTAATACINI, 'DD-MM-YY')|| ' 00:00:01','DD-MM-YY HH24:MI:SS','NLS_DATE_LANGUAGE = AMERICAN')
