...
(
  ...
  WHERE 
    ...
    AND SYSDATE BETWEEN 
	    TO_DATE(PCOFERTAPROGRAMADAC.DTINICIAL   || ' ' || NVL(TO_CHAR(PCOFERTAPROGRAMADAC.HORAINICIAL, 'HH24:MI:SS'), '00:00:01' ),'DD-MM-YY HH24:MI:SS','NLS_DATE_LANGUAGE = AMERICAN')
		  AND TO_DATE(PCOFERTAPROGRAMADAC.DTFINAL || ' ' || NVL(TO_CHAR(PCOFERTAPROGRAMADAC.HORAFINAL  , 'HH24:MI:SS'), '23:59:59' ),'DD-MM-YY HH24:MI:SS','NLS_DATE_LANGUAGE = AMERICAN')
    ...
    AND PCOFERTAPROGRAMADAC.PRIORIDADEOFERTA = (
      ...
      WHERE 
        ...
        AND SYSDATE BETWEEN
          TO_DATE(P.DTINICIAL || ' ' || NVL(TO_CHAR(P.HORAINICIAL, 'HH24:MI:SS'), '00:00:01' ), 'DD-MM-YY HH24:MI:SS', 'NLS_DATE_LANGUAGE = AMERICAN')
          AND TO_DATE(P.DTFINAL || ' ' || NVL(TO_CHAR(P.HORAFINAL, 'HH24:MI:SS'), '23:59:59' ), 'DD-MM-YY HH24:MI:SS', 'NLS_DATE_LANGUAGE = AMERICAN')
        AND I.VLOFERTA > 0
    )
