      ...
      SELECT 
         ...
         (CASE
            WHEN FERRAMENTAS.F_BUSCARPARAMETRO_ALFA('FIL_PRECOPOREMBALAGEM', F.CODFILIAL, 'N') = 'S' THEN
                 COLUNA_PRECO(BUSCAPRECOS(C5.CODFILIAL, 0, F.CODAUXILIARMP, TRUNC(SYSDATE)),'PVENDA')
            ELSE COLUNA_PRECO(BUSCAPRECOS(C5.CODFILIAL, FERRAMENTAS.F_BUSCARPARAMETRO_NUM('NUMREGIAOPADRAOVAREJO', F.CODFILIAL, 1), F.CODAUXILIARMP, TRUNC(SYSDATE)),'PVENDA1')
