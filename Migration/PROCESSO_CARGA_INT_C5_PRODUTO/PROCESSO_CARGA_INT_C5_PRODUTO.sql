...
--OFERTA 2011 ATACADO
 SELECT
  ...
  INNER JOIN (
    ...
    ON GREATEST(NVL(P.DTALTERC5, DATAPADRAO.ULTIMAEXECUCAO), NVL(E.DTALTERC5, DATAPADRAO.ULTIMAEXECUCAO)) >= DATAPADRAO.ULTIMAEXECUCAO
...
GROUP BY CESTA.CODPRODACAB, CESTA.NROEMPRESA, CESTA.CODAUXILIARACAB, C.SEQPRODUTO
