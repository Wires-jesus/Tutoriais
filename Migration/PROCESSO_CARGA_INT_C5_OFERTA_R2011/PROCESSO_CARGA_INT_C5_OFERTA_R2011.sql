...
SELECT DISTINCT 
  ...
  AND C.SEQPRODUTO = ora_hash(a.codauxiliar, 2147483647) seqproduto,
...
SELECT DISTINCT
  ...
  --AND    C.SEQPRODUTO = E.CODAUXILIAR
  AND    C.SEQPRODUTO = ora_hash(OFERTA_HIST.codauxiliar, 2147483647) seqproduto,
