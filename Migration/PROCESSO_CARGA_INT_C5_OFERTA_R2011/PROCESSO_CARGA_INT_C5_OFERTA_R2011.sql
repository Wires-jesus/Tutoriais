...
SELECT DISTINCT a.codauxiliar||a.codfilial as SEQPRODUTO,
  ...
  AND C.SEQPRODUTO = E.CODAUXILIAR||E.CODFILIAL
...
UNION
SELECT DISTINCT
       OFERTA_HIST.CODAUXILIAR||OFERTA_HIST.CODFILIAL as SEQPRODUTO,
  ...
  GROUP BY OFERTA_HIST.CODAUXILIAR||OFERTA_HIST.CODFILIAL,
