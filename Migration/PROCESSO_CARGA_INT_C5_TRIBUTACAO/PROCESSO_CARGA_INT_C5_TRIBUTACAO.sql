...
(
 ...
 FROM
     (SELECT DISTINCT
      ...
      WHERE T.SEQFAMILIA = TB.CODPROD
      AND   TB.CODST = C.CODST
      AND   TB.CODST = F.NROTRIBUTACAO
      AND   C.CODST = F.NROTRIBUTACAO
      AND   C.NUMREGIAO = D.NUMREGIAO
      AND   TB.CODFILIALNF = C5.CODFILIAL
      AND   TB.CODFILIALNF = E.NROEMPRESA
      AND   E.NROEMPRESA = C5.CODFILIAL
      AND   E.NROEMPRESA = P.CODIGO
      AND   P.UF  = TB.UFDESTINO
