...
AND   E.ROTINA = 'PCSIS4008'
AND   S.CODAJUSTEEFD = E.CODCADASTROPRINC
AND   R.CODPROD = FAM.SEQFAMILIA
AND   P.CODPROD = FAM.SEQFAMILIA
AND   E.CODEXCECAO = E.CODEXCECAO
AND   T.IDREF = E.CODCADASTROPRINC
AND   T.CODOBSERVACAO = S.CODOBSERVACAO
AND   T.NROTRIBUTACAO = R.CODST
AND   NVL(E.VALOR1, '0') = (DECODE(NVL(E.TIPO1,'XX'), 'PR', TO_CHAR(P.CODPROD), 'FT', TO_CHAR(R.CODST), 'CM', TO_CHAR(P.NBM)))
)